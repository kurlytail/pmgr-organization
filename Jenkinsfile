    ...
    stages {
        stage('Prepare env') {
            ...
            steps {
                script {
                    loadLibrary()
                    env['MAVEN_VERSION_NUMBER'] = getMavenVersion 'kurlytail/pmgr-organization/master', params.BUILD_VERSION_PREFIX, params.BUILDS_OFFSET
                }
            }
        }
        ...
        stage ('Build') {
            ...
            steps {
                ...
                sh 'rm -rf pmgr-organization/*'
                dir ('pmgr-organization') {        
                    checkout scm
                }
